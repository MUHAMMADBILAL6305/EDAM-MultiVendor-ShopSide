import 'dart:async';
import 'package:edam_merchant/presentation/screens/credentials/reset_password.dart';
          ...
          children: [
            Container(
              ...
              decoration:  BoxDecoration(
                  ...
                  color: Theme.of(context).backgroundColor, borderRadius: const BorderRadius.only(topLeft: Radius.circular(12),topRight: Radius.circular(12))),
              child: Column(
                children: [
                  Align(
